...
function showCartNotification() {
    // Removed notification - user requested no messages
}
...
function checkout() {
    ...
    // Redirect directly to Hotmart without any confirmation or alert
    window.open('https://hotmart.com/pt-br/marketplace/produtos/prof-vane-pdfs-materiais-pedagogicos', '_blank');
...
// Direct buy function for individual products
function buyProduct(productId) {
    const hotmartLinks = {
        1: 'https://hotmart.com/pt-br/marketplace/produtos/atividades-alfabetizacao-prof-vane',
        2: 'https://hotmart.com/pt-br/marketplace/produtos/matematica-fundamental-prof-vane',
        3: 'https://hotmart.com/pt-br/marketplace/produtos/geografia-interativa-prof-vane',
        4: 'https://hotmart.com/pt-br/marketplace/produtos/portugues-dinamico-prof-vane'
    };
    
    const link = hotmartLinks[productId] || 'https://hotmart.com/pt-br/marketplace/produtos/prof-vane-pdfs';
